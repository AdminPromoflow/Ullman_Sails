...
$imgFile1    = __DIR__ . '/2.Services/Image/Nav_Main.2048_0_1.png';
$imgVersion1 = is_file($imgFile1) ? filemtime($imgFile1) : null;

$imgFile2    = __DIR__ . '/2.Services/Image/Nav_Head.2048_0_1.png';
$imgVersion2 = is_file($imgFile2) ? filemtime($imgFile2) : null;

$imgFile3    = __DIR__ . '/2.Services/Image/Nav_Jib.2048_0_1.png';
              ...
              <figure class="nav-rotator" aria-label="Navigator sail image rotator" data-interval="3000">
                <div class="nav-rotator__frame">
                  <img class="nav-rotator__img is-active"
                       src="2.Services/Image/Nav_Main.2048_0_1.png<?= $imgVersion1 ? '?v='.$imgVersion1 : '' ?>"
                       alt="Navigator Series sail view 1"
                       data-sub="MAINSAIL">

                  <img class="nav-rotator__img"
                       src="2.Services/Image/Nav_Head.2048_0_1.png<?= $imgVersion2 ? '?v='.$imgVersion2 : '' ?>"
                       alt="Navigator Series sail view 2"
                       data-sub="HEADSAIL">

                  <img class="nav-rotator__img"
                       src="2.Services/Image/Nav_Jib.2048_0_1.png<?= $imgVersion3 ? '?v='.$imgVersion3 : '' ?>"
