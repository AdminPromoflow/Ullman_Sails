<?php
$sliderCss =  '../SailCare/1_slider/slider.css';
$sliderJs  =  '../SailCare/1_slider/slider.js';

$sliderCssTime = file_exists($sliderCss) ? filemtime($sliderCss) : time();
$sliderJsTime  = file_exists($sliderJs)  ? filemtime($sliderJs)  : time();
?>

<link rel="stylesheet" href="../SailCare/1_slider/slider.css?v=<?= $sliderCssTime ?>">
    ...
    <article class="home-slider__slide bg-cruising-2 is-caption-left" data-clone="last" aria-hidden="true">
      <div class="home-slider__caption">
        <div class="home-slider__kicker">
          <img src="../SailCare/1_slider/img/ullman_sails.png" alt="">
        </div>
        <h1 class="home-slider__title">Protect performance. Extend lifespan.</h1>
        <h2 class="home-slider__subtitle">Sail Care Essentials</h2>
...
<!-- 1 -->
    <article class="home-slider__slide bg-cruising-1">
      <div class="home-slider__caption">
        ...
        <h1 class="home-slider__title">Keep Performance Longe</h1>
        <h2 class="home-slider__subtitle">Sail Care.</h2>
        <div class="home-slider__line" aria-hidden="true"></div>
...
<script src="../SailCare/1_slider/slider.js?v=<?= $sliderJsTime ?>" defer></script>
