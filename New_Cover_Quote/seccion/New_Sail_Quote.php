<?php
$css_file = __DIR__ . '/../New_Cover_Quote/seccion/New_Sail_Quote.css';
$js_file  = __DIR__ . '/../New_Cover_Quote/seccion/New_Sail_Quote.js';
...
<script  src="../New_Cover_Quote/seccion/New_Sail_Quote.js?v=<?= $js_time ?>"></script>
