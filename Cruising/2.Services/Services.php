              ...
              <div class="navSeries__mediaCol">
                <figure class="navSeries__media">
                  <img class="navSeries__img"
                       src="../Cruising/2.Services/Image/EnduranceSeries.jpg"
                       alt="Endurance Series cruising sails in stronger conditions"
                       loading="lazy"
                       decoding="async" />
                </figure>

                <a class="navSeries__brochure" href="../Cruising-2.Endurance/index.php">VIEW BROCHURE</a>
              </div>
