      ...
      <div class="nav-specsheet__grid">
        ...
        <figure class="nav-rotator" aria-label="Performance sail image rotator" data-interval="3000">
          <div class="nav-rotator__frame">
            <img class="nav-rotator__img is-active"
                 ...
                 alt="Performance Series sail view 1"
                 data-sub="MAINSAIL, THE PERFORMANCE SERIES">

            <img class="nav-rotator__img"
                 src="../cruising_navigator/5_cloth_and_construction/img/sail_2.png"
                 alt="Performance Series sail view 2"
                 data-sub="HEADSAIL, THE PERFORMANCE SERIES">

            <img class="nav-rotator__img"
                 src="../cruising_navigator/5_cloth_and_construction/img/sail_3.png"
                 alt="Performance Series sail view 3"
                 data-sub="JIB, THE PERFORMANCE SERIES">
          </div>

          <figcaption class="nav-rotator__caption">
            <span class="nav-rotator__capTitle">THE PERFORMANCE SERIES</span>
            <span class="nav-rotator__capSub">MAINSAIL, THE PERFORMANCE SERIES</span>
        ...
        <div class="nav-specsheet__text">
          <div class="nav-specsheet__meta">
            <div class="nav-specsheet__metaTop">ULTRALAM</div>
            <div class="nav-specsheet__metaSub">RADIAL CARBON ULTRA PE HIGH END LAMINATE</div>
          </div>
          ...
          <div class="nav-specsheet__list">
            <div class="nav-specsheet__row">
              ...
              <div class="nav-specsheet__val">RADIAL CARBON ULTRA PE HIGH END LAMINATE</div>
            </div>

            <div class="nav-specsheet__row">
              <div class="nav-specsheet__key">PERFORMANCE FIBERPATH</div>
