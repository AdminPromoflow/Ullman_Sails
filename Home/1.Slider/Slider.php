<?php
$sliderCss = __DIR__ . '/../Home/1.Slider/Slider.css';
$sliderJs  = __DIR__ . '/../Home/1.Slider/Slider.js';

$sliderCssTime = file_exists($sliderCss) ? filemtime($sliderCss) : time();
$sliderJsTime  = file_exists($sliderJs)  ? filemtime($sliderJs)  : time();
?>

<link rel="stylesheet" href="../Home/1.Slider/Slider.css?v=<?= $sliderCssTime ?>">
  ...
  <div id="homeSliderTrack" class="home-slider__track">
    ...
    <article class="home-slider__slide bg-cruising-2">
      <div class="home-slider__caption">
        ...
        <h1 class="home-slider__title">CRUISING SAILS 2</h1>
...
<script src="../Home/1.Slider/Slider.js?v=<?= $sliderJsTime ?>" defer></script>
