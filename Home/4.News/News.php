...
$newsCssFs = __DIR__ . '/home/4.News/News.css';
$newsJsFs  = __DIR__ . '/home/4.News/News.js';

$newsCssPublic = '../home/4.News/News.css';
$newsJsPublic  = '../home/4.News/News.js';

$newsCssV = is_file($newsCssFs) ? filemtime($newsCssFs) : time();
$newsJsV  = is_file($newsJsFs) ? filemtime($newsJsFs) : time();
?>

<link rel="stylesheet" href="<?= $newsCssPublic ?>?v=<?= $newsCssV ?>">
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  ...
                  type="button"
                  data-url="../News/index.php#news-rc1000"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-inshore-offshore"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-quarter-ton-cup"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-loft-updates"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-customer-updates"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-quarter-tonner-developments"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-london-boat-show"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-newest-team-member"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-penarth-code-zero"
                >
                  See more
                </button>
              </div>
            ...
            <div class="news-card__body">
              ...
              <div class="news-card__cta-wrap">
                <button
                  class="news-card__cta news-card__cta--primary"
                  type="button"
                  data-url="../News/index.php#news-once-in-a-lifetime-storm"
                >
                  See more
                </button>
              </div>
...
<script defer src="<?= $newsJsPublic ?>?v=<?= $newsJsV ?>" type="text/javascript"></script>
