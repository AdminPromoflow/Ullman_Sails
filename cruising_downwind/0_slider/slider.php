<?php
$sliderCss =  '../cruising_downwind/0_slider/slider.css';
$sliderJs  =  '../cruising_downwind/0_slider/slider.js';

$sliderCssTime = file_exists($sliderCss) ? filemtime($sliderCss) : time();
$sliderJsTime  = file_exists($sliderJs)  ? filemtime($sliderJs)  : time();
?>

<link rel="stylesheet" href="../cruising_downwind/0_slider/slider.css?v=<?= $sliderCssTime ?>">
    ...
    <article class="home-slider__slide bg-cruising-2 is-caption-left" data-clone="last" aria-hidden="true">
      <div class="home-slider__caption">
        <div class="home-slider__kicker">
          <img src="../cruising_downwind/0_slider/img/ullman_sails.png" alt="">
        </div>
        <h1 class="home-slider__title">Downwind Sails</h1>
        <h2 class="home-slider__subtitle">Optimised for broad reaches and deep angles.</h2>
...
<!-- 1 -->
    <article class="home-slider__slide bg-cruising-1">
      <div class="home-slider__caption">
        ...
        <h1 class="home-slider__title">Downwind Sails</h1>
        <h2 class="home-slider__subtitle">Purpose-built for fast, stable downwind sailing.</h2>
        <div class="home-slider__line" aria-hidden="true"></div>
...
<script src="../cruising_downwind/0_slider/slider.js?v=<?= $sliderJsTime ?>" defer></script>
